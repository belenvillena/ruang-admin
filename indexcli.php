...
require_once 'secciones/encabezadotienda.php'; ?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Bienvenido a tu cuenta "nombrecliente"</h1>
            <ol class="breadcrumb">
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Consulta</div>
         
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Consulta
          </div>
