...
if (isset($_GET['action']) && $_GET['action']=="add") 
{
    ...
    {
        $sql_s= "SELECT * FROM producto WHERE idProducto= {$id}";
        $query_s=mysql_query($sql_s);

        if (mysql_num_rows($query_s))
         {
            $row_s=mysql_fetch_array($query_s);
            $_SESSION['cart'][$row_s['idProducto']]=array("quantity"=>1,
                "price"=>$row_s['precioProd']);
        }
        else
        {
            $message="Invalidate";
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="product-name"><a href="#">Berenjena</a></td>
                                            <td class="product-price"><span class="amount">$1800.00</span></td>
                                            <td class="product-quantity"><input type="number" value="10" /></td>
                                            <td class="product-subtotal">$18000.00</td>
                                            <td class="product-remove"><a href="#">X</a></td>
                                        </tr>
                                        <tr>
                                            
                                            <td class="product-name"><a href="#">Tomate perita</a></td>
                                            <td class="product-price"><span class="amount">$1800.00</span></td>
                                            <td class="product-quantity"><input type="number" value="5" /></td>
                                            <td class="product-subtotal">$9000.00</td>
                                            <td class="product-remove"><a href="#">X</a></td>
                                        </tr>
                                    </tbody>
                                </table>
